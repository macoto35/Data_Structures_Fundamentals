...
public class DisJointSetArrayTest {

    private DisJointSetArray set;

    @BeforeEach
    public void setUp() {
        this.set = new DisJointSetArray();
    }
    ...
    public void union() {
        ...
        this.set.union(1, 3);
        assertEquals("0,1,1,1,4,5,6,7,1,", this.set.toString());

        this.set.union(3, 6);
        assertEquals("0,1,1,1,4,5,1,7,1,", this.set.toString());

        this.set.union(5, 0);
        assertEquals("0,1,1,1,4,0,1,7,1,", this.set.toString());

        this.set.union(0, 7);
        assertEquals("0,1,1,1,4,0,1,0,1,", this.set.toString());
    }
}
